...
void Engine_Interface::render_dev_info(){
    ...
    if(game.in_progress){
        ...
        msg+="Objects: "+string_stuff.num_to_string(game.world.objects.size())+"\n";

        msg+="\n";
        msg+="Mass: "+string_stuff.num_to_string(game.world.objects[0].mass)+" kg"+"\n";
        msg+="Velocity: "+string_stuff.num_to_string(game.world.objects[0].velocity.magnitude)+" m/s "+string_stuff.num_to_string(game.world.objects[0].velocity.direction)+string(1,(unsigned char)167)+"\n";
    }
